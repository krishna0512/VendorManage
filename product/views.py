...
class ProductUpdateView(PermissionRequiredMixin, UpdateView):
    ...
    permission_required = ('product.view_product','product.change_product')
...
class ProductCreateView(PermissionRequiredMixin, CreateView):
    ...
    permission_required = ('product.view_product','product.add_product')
    ...
    def get_success_url(self):
        if 'save_add_another' in self.request.POST:
            return reverse_lazy('product:create', kwargs={'kit_number': self.kwargs['kit_number']})
        else:
...
class ProductDeleteView(PermissionRequiredMixin, DeleteView):
    model = Product
    permission_required = ('kit.view_kit','product.view_product','product.delete_product')
...
class ProductReturnRedirectView(PermissionRequiredMixin, SingleObjectMixin, RedirectView):
    model = Product
    permission_required = ('kit.view_kit','product.view_product','product.change_product',)
...
class ProductSplitRedirectView(PermissionRequiredMixin, SingleObjectMixin, RedirectView):
    model = Product
    permission_required = (
        'kit.view_kit', 'product.view_product',
